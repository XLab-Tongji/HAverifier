...
from attacker_process import ProcessAttacker
...
class SwiftServiceAttacker(ProcessAttacker):

    __attacker_type__ = 'swift-service'
    ...
    def inject_fault(self):
        exit_status, stdout, stderr = self.connection.execute(
            "/bin/bash -s {0}".format(self.service_name),
    ...
    def check(self):
        ...
        if stdout and "X-Account-Project-Domain-Id" in stdout:
